...
"use strict";
Vue.component("Lang-Sprite", {
    dependencies: ["packages://inspector/share/blend.js"],
    template: `
            <ui-prop name="SpriteUrl" tooltip="{{T(\'game-helper.LangSprite\')}}">
    ...
    watch: {
        target() {
            this._updateAtlas(), this._updateSprite(), this._updateSpriteUrl()
        }
    },
    methods: {
        T: Editor.T,
        ...
        _updateSpriteUrl() {
            ...
            if (url) {
                if (!url.startsWith("db://assets/resources/Lang")) {
                    Editor.error(`${url} -> not in Lang path`);
                    url = "";
                } else {
